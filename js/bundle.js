...
function forms(fromSelector, modalTimerId) {
  var forms = document.querySelectorAll(fromSelector);
  var message = {
...
function slider(_ref) {
  ...
  var slideIndex = 1;
  var offset = 0; //Простой вариант слайдера
  ...
  function adaptNavigation(counter, dots) {
    if (slides.length < 10) {
      counter.textContent = "0".concat(slideIndex);
    } else {
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2020-10-30');
